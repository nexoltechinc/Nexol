...
const industries = [
  {
    ...
    description: 'Brands that need better storefronts, order workflows, customer journeys, reporting, and backend automation.',
    icon: Stethoscope,
  ...
  },
  {
    ...
    description: 'Teams that need secure dashboards, reporting tools, portals, internal workflows, and stronger digital operations.',
    icon: ShieldCheck,
  ...
  {
    name: 'Healthcare',
    description: 'Healthcare teams that need call handling, scheduling support, portals, dashboards, and custom workflow systems.',
    icon: Building2,
    span: 'col-span-1 lg:col-span-1',
    color: '#8b5cf6', // Violet
  ...
  },
  {
    ...
    description: 'Growing teams that need better websites, lead handling, follow-up, automation, and practical digital systems.',
    icon: Calendar,
    span: 'col-span-1 md:col-span-2 lg:col-span-2',
    color: '#06b6d4', // Cyan
  ...
  },
  {
    ...
    description: 'Companies that need scheduling, CRM workflows, internal tools, customer communication, and faster response time.',
    icon: LineChart,
    span: 'col-span-1 lg:col-span-1',
    color: '#f43f5e', // Rose
  ...
  },
  {
    ...
    description: 'Internal teams that need dashboards, handoff logic, process automation, and better visibility into daily work.',
    icon: Users,
    span: 'col-span-1 lg:col-span-1',
    color: '#f59e0b', // Amber
        ...
        <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-12 mb-16">
          ...
          >
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/[0.03] border border-white/[0.08] mb-8 backdrop-blur-xl group cursor-default">
               ...
               <span className="text-[11px] font-black text-slate-400 tracking-[0.3em] uppercase">Industries We Support</span>
            </div>
            <h2 className="text-3xl sm:text-5xl lg:text-6xl font-black text-white mb-6 sm:mb-8 tracking-tighter leading-[1.05]">
              Built For Real Business <br/> 
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 via-blue-500 to-[#6F3DFF]">Operations First.</span>
            </h2>
            <p className="text-base sm:text-xl lg:text-2xl text-slate-400 max-w-2xl font-light leading-relaxed">
              Nexol works across healthcare, finance, retail, small business, and service operations when the company needs better digital systems, cleaner workflows, and stronger visibility.
            </p>
          </motion.div>
