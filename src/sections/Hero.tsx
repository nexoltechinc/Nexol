      ...
      <div className="relative z-10 mx-auto w-full max-w-7xl px-6 sm:px-8 lg:px-12">
        <div className="grid lg:grid-cols-12 gap-6 lg:gap-10 items-center">
          ...
          >
            ...
            <motion.div variants={itemVariants} className="inline-flex items-center gap-3 px-4 sm:px-5 py-2.5 rounded-full bg-cyan-500/10 border border-cyan-500/20 mb-5 sm:mb-6 w-fit backdrop-blur-xl shadow-[0_0_30px_rgba(34,211,238,0.1)] relative overflow-hidden group">
            ...
            <motion.p variants={itemVariants} className="text-[15px] sm:text-lg lg:text-xl text-slate-300 font-light mb-5 sm:mb-6 max-w-xl leading-relaxed drop-shadow-md">
