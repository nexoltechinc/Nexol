...
const Navigation = () => {
  ...
  const sidebarLinks = [
    { name: 'AI Calling Agent', href: '/ai-calling-agent', icon: Bot, desc: 'Healthcare voice automation' },
    { name: 'Business Solutions', href: '/solutions', icon: Database, desc: 'Web, CRM, dashboards, automation' },
    { name: 'Industries', href: '/industries', icon: Zap, desc: 'Finance, healthcare, retail, SMBs' },
        ...
        >
          ...
          <div className="flex items-center gap-2 sm:gap-6 shrink-0">
            <div className="hidden md:flex flex-col items-end mr-2 text-right">
                <span className="text-[10px] text-slate-500 font-bold uppercase tracking-widest">Business Support</span>
              ...
              <div className="flex justify-between items-center mb-8 sm:mb-12">
                 <div className="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p className="text-[10px] text-slate-500 font-bold uppercase tracking-widest">Nexol Business Navigation</p>
                    </div>
                 </div>
                 <button 
                   onClick={() => setIsSidebarOpen(false)}
              ...
              <div className="mt-auto pt-8 sm:pt-10 border-t border-slate-900 flex flex-col gap-8">
                 <div className="flex flex-col sm:flex-row gap-6 sm:gap-10">
                    ...
                    <div>
                        ...
                        <button onClick={() => { navigate('/contact'); setIsSidebarOpen(false); }} className="text-xs text-blue-400 font-bold hover:underline">Book Free Consultation</button>
                    </div>
                 </div>
                 <div className="p-5 sm:p-6 rounded-[2rem] bg-gradient-to-br from-blue-600 to-cyan-600 flex items-center justify-between gap-4">
                    <div>
                        <p className="text-white font-black text-base sm:text-lg">Ready to improve your systems?</p>
                        <p className="text-white/70 text-sm">Book your free consultation.</p>
                    </div>
